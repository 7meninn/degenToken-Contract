...
contract degenStudio is ERC20, Ownable {
    ...
    string public storeItemNames = "0. Car NFT (50) 1. Art NFT (100) 2. Legend NFT (500)";
    ...
    function makeBuyRequest(uint _choice, uint _whatPrice) public returns (bool) {
        if (walletBalance(msg.sender) < _whatPrice) {
            return false;
        }
        requests.push(requestStructure(msg.sender, _choice, _whatPrice, 1));
        return true;
    }
